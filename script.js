...
let blogName = "autistic library";
let authorName = "blooshy";
...
[ "posts/2024-01-02-Happy-New-Year!.html"],
[ "posts/2023-12-14-Monster-Hunter-Rise.html"],
[ "posts/2023-11-05-Super-Mario-Bros-Wonder-Review.html"],
[ "posts/2023-10-24-Small-Update-ft-a-vent.html"],
[ "posts/2023-07-27-Saying-hello-again.html" ],
[ "posts/2023-07-27-Creating-a-website.html" ],
...
'<li><a href="' + relativePath + '/gallery.html">Gallery</a></li>' +
'<li><a href="' + relativePath + '/about.html">About</a></li>' +
'<li><a href="' + relativePath + '/guestbook.html">Guestbook</a></li> </ul>';

//Write the Footer HTML, which has information about the blog.
let footerHTML = "<hr><p>Two apple per day keeps the doctor away. (⌒U⌒)</p>";
...
let recentPostListHTML = "<h2 style='background-color:#fff5cc;'>Recent Posts:</h2><ul>";
...
if (document.body) {
    if (7 <= currentTime && currentTime < 20) {
        document.body.background = "./style/bg.png";
    }
    else {
        document.body.background = "./style/bgnight.png";
    }
}